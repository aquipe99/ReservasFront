                ...
                <div class="layout-topbar-menu-content">
                    <div class="flex items-center gap-2 px-3">
                        ...
                        <div class="flex flex-col">
                            <span class="font-medium">{{ auth.userSignal()?.name }}</span>
                            <small class="text-muted-color">{{ auth.userSignal()?.role }}</small>
                        </div>
                    </div>
                    <p-button label="Salir" icon="pi pi-sign-out" [text]="true" (onClick)="logout()" />
                </div>
            </div>
        </div>
    </div>`
